...
You can then execute your native executable with: `./target/camelk-1.0-SNAPSHOT-runner`
...
- Camel Git ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/git.html)): Perform operations
  on git repositories
